...
public class ModItems {
    ...
    private static final RegistryObject<Item> NETHERITE_COSMETIC = ITEMS.register("netherite_cosmetic", () -> new ArmorItem(ModArmourMaterials.COSMETIC_NETHERITE, ArmorItem.Type.HELMET, new Item.Properties()));
